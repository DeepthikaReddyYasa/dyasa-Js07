...
// //     // Now you have the word frequency data in the wordFreq object.
// //     // You can use this data to create the word cloud.

// //     // For example, you can display the word cloud on the page.

// //     // Sort the words by frequency in descending order
// //      let sortedWords = Object.keys(wordFreq);

// //     // Display the word cloud on the page
// //     let wordCloudContainer = document.getElementById("wc_cloud");
// //     wordCloudContainer.innerHTML = "";

// //     for (let word of sortedWords) {
// //         let wordElement = document.createElement("span");
// //         wordElement.textContent = word;
// //         wordElement.style.fontSize = `${wordFreq[word] * 3}px`; // You can adjust the font size as needed
